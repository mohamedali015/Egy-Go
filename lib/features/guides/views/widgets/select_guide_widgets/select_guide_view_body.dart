...
class SelectGuideViewBody extends StatelessWidget {
  const SelectGuideViewBody({super.key, required this.tripId});
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      onRefresh: () async {
        await SelectGuideCubit.get(context).fetchTripGuides(tripId);
      },
      child: BlocBuilder<SelectGuideCubit, SelectGuideState>(
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Expanded(
                    child: SelectGuideListView(
                        guides: cubit.filteredGuides, tripId: tripId),
                  ),
                  SizedBox(height: MyResponsive.height(value: 16)),
                ],
              ),
